...
export const ProjectsList = [
  {
    ...
    banner: '/img/projects/placerhama.png',
    tags: [
  ...
  },
  {
    ...
    banner: '/img/projects/cactus-espacial.png',
    tags: [
      { label: 'Logo', filter: 'logo' },
      { label: 'Ilustración', filter: 'ilustracion' }
    ]
  },
  {
    id: 3,
    ...
    banner: '/img/projects/botones-hover.gif',
    tags: [
      { label: 'Front-End', filter: 'front-end' },
      { label: 'UXI', filter: 'uxi' }
    ]
  }
];
